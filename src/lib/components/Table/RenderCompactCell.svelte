<script lang="ts">
    ...
    const colors = subjectsData.map((sub) => {
        switch(sub.type) {
            case "course":
                return "#5B72AB";
            case "laboratory":
...
<td style="background-image: {returnGradient()}; white-space: pre-line; border: solid 1px #484C6C; box-shadow: inset 0 0 50px #484B5F99;">
